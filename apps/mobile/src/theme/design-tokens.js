...
module.exports = { brand, neutral, category, glass, mesh, motion, type, radius, gradients, commerce, theme, shadow, touch };
export default { brand, neutral, category, glass, mesh, motion, type, radius, gradients, commerce, theme, shadow, touch };
