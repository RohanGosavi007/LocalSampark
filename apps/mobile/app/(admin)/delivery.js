...
export default function AdminDeliveryScreen() {
  ...
  const fetchData = async () => {
    try {
      ...
      const res = await fetch(`${API_BASE}/admin/delivery/agents`, {
        headers: {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>🚴 Delivery Telemetry</Text>
      </View>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text style={styles.emptyText}>No data available for Delivery Telemetry</Text>}
        />
      )}
    </SafeAreaView>
  );
