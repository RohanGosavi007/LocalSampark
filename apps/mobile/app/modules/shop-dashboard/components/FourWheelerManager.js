  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>🚘 4-Wheeler Garage & Service Center</Text>
      </View>

      <View style={styles.card}>
        <Text style={styles.cardTitle}>Live Repair Status Board</Text>
        <Text style={styles.cardDesc}>Track cars currently in service bays.</Text>
        <View style={styles.bayRow}>
          <View style={styles.bay}>
            <Text style={styles.bayTitle}>Bay 1</Text>
            <Text style={styles.bayVehicle}>Maruti Suzuki Swift (Denting & Painting)</Text>
        ...
        <View style={styles.bayRow}>
          <View style={styles.bay}>
            ...
            <Text style={styles.bayVehicle}>Hyundai Creta (Engine Service)</Text>
      ...
      <View style={styles.card}>
        <Text style={styles.cardTitle}>🚨 Roadside Assistance & Towing (4-Wheeler)</Text>
