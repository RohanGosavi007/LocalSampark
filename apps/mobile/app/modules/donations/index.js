...
export default function MobileDonations() {
  ...
  const fetchNgos = async () => {
    try {
      const data = await apiGet('/donations/ngos');
  ...
  const fetchCrowdfunds = async () => {
    try {
      const data = await apiGet('/donations/crowdfund');
  ...
  const fetchRescues = async () => {
    try {
      const data = await apiGet('/donations/rescue');
  ...
  const fetchAdminConfig = async () => {
    try {
      const data = await apiGet('/donations/admin/config');
  ...
  const handleCreateNidhi = async () => {
    ...
    try {
      const data = await apiPost('/donations/crowdfund', nidhiForm);
      if (data.success) {
  ...
  const handlePostRescue = async () => {
    ...
    try {
      const data = await apiPost('/donations/rescue', rescueForm);
      if (data.success) {
  ...
  const handleUpdateAdmin = async () => {
    Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Medium);
    try {
      const data = await apiPost('/donations/admin/config', { subsidized: adminConfig.deliverySubsidized, bonus: adminConfig.surpriseBonusAmount });
      if (data.success) {
