  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Text style={styles.desc}>Track your vehicle's service status.</Text>
      ...
      <View style={styles.cardEmergency}>
        ...
        <Text style={styles.desc}>Stuck on the road? We'll send a tow truck or mechanic to your GPS location.</Text>
