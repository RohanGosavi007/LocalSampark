      ...
      <main style={{ flex: 1, padding: '4rem 0', background: 'var(--bg)' }}>
        <div className='container'>
          <div className='glass-card' style={{ padding: '3rem', textAlign: 'center' }}>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem', textTransform: 'capitalize' }}>Welcome to Feature: refurbished-phones</h2>
            <p style={{ color: 'var(--text-muted)' }}>This feature module has been successfully integrated as part of the Rural & Krishi Expansion V4.</p>
