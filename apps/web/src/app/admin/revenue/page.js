        ...
        <div className="w-64 bg-slate-900 border-r border-slate-800 hidden md:block fixed h-full z-10 pt-6">
          <div className="px-6 mb-8">
            <h2 className="text-xl font-black text-white flex items-center gap-2">
              <ShieldCheck className="text-emerald-500" /> GOD MODE
            </h2>
          ...
          <div className="px-4 space-y-2">
            <Link href="/admin-dashboard" className="flex items-center gap-3 px-4 py-3 rounded-xl text-slate-400 hover:bg-slate-800 hover:text-white transition">
              <Activity className="w-5 h-5" /> <span className="font-medium">Platform Health</span>
            </Link>
            <Link href="/admin/revenue" className="flex items-center gap-3 px-4 py-3 rounded-xl bg-emerald-600/10 text-emerald-400 border border-emerald-500/20 transition">
              <IndianRupee className="w-5 h-5" /> <span className="font-medium">Revenue</span>
            </Link>
