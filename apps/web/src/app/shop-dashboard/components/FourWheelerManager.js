...
export default function FourWheelerManager({ shop }) {
  ...
  return (
    <div className="garage-manager glass-card" style={{ padding: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        <div>
          <h2>4-Wheeler Garage Manager</h2>
          <p style={{ color: 'var(--text-muted)' }}>Complete lifecycle management for cars and SUVs</p>
        </div>
      </div>
