...
export default function TwoWheelerManager({ shop }) {
  ...
  return (
    <div className="garage-manager glass-card" style={{ padding: '2rem' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
        <div>
          <h2>2-Wheeler Garage Manager</h2>
          <p style={{ color: 'var(--text-muted)' }}>Complete lifecycle management for bikes and scooters</p>
        </div>
      </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginTop: '1.5rem' }}>
            <div>
              ...
              <select className="form-input">
                <option selected>🏍️ 2-Wheeler</option>
