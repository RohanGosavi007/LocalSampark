      ...
      <div className="max-w-3xl mx-auto pt-24 px-4 pb-20">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-400 mt-1">1,204 Verified Residents</p>
          </div>
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 mb-6 flex gap-4">
          ...
          <div className="flex-1">
            <input 
              ...
              className="w-full bg-slate-950 border border-slate-800 rounded-xl px-4 py-3 text-white outline-none focus:border-blue-500 transition-colors mb-3"
            />
            <div className="flex justify-between items-center">
              <div className="flex gap-2">
                <button className="text-slate-400 hover:text-blue-400 p-2 rounded-lg hover:bg-slate-800 transition-colors"><ImageIcon size={18} /></button>
                <button className="text-slate-400 hover:text-blue-400 p-2 rounded-lg hover:bg-slate-800 transition-colors">Poll</button>
              </div>
              ...
              <div className="flex justify-between items-start mb-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-500 text-xs">{post.time} • {post.type}</p>
                  </div>
                </div>
              </div>
              
              <p className="text-slate-300 mb-4 text-[15px] leading-relaxed">
                {post.content}
              </p>
