    ...
    <div className="max-w-7xl mx-auto pb-12 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          {/* Mobile Preview */}
          <div className="bg-slate-900 border rounded-3xl p-6 shadow-xl relative overflow-hidden" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
          ...
          <div className="bg-slate-900 border rounded-3xl p-6 shadow-xl max-h-96 overflow-y-auto" style={{ backgroundColor: 'var(--bg-card)', borderColor: 'var(--border-color)' }}>
            <h2 className="text-xl font-bold mb-4 flex items-center gap-2 sticky top-0 bg-slate-900 pb-2 z-10" style={{ color: 'var(--text-main)', backgroundColor: 'var(--bg-card)' }}>
