...
export default function ConsentBanner() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4 md:p-6 animate-slide-up pointer-events-none">
      <div className="max-w-4xl mx-auto bg-background border-2 border-border rounded-2xl shadow-[0_-10px_40px_rgba(0,0,0,0.5)] p-6 pointer-events-auto flex flex-col md:flex-row gap-6 items-center justify-between">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <h3 className="font-bold text-text text-lg mb-1">Your Privacy Matters</h3>
        ...
        <div className="flex w-full md:w-auto gap-3 shrink-0">
          <button 
            ...
            className="flex-1 md:flex-none px-6 py-3 rounded-xl font-bold border border-border text-text-muted hover:bg-card-bg transition-colors flex items-center justify-center gap-2"
          >
            <X size={18} />
            Decline
          </button>
