    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      <div style={cardStyle}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          <div>
            <h3 style={{ fontSize: '1.1rem', margin: 0, color: '#f8fafc' }}>🤝 Charity & NGO Management</h3>
            <p style={{ color: '#64748b', fontSize: '0.85rem', margin: '0.2rem 0 0' }}>Audit donations, volunteers, and local NGO registrations.</p>
          </div>
          <button style={btnPrimary}>Verify NGO List</button>
        </div>
        
        {loading ? <p style={{ color: '#94a3b8' }}>Loading charity metrics...</p> : (
