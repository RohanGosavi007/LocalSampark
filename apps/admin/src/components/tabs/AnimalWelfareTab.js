    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      <div style={cardStyle}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
          <div>
            <h3 style={{ fontSize: '1.1rem', margin: 0, color: 'var(--ink)' }}>🐾 Animal Welfare & Pets</h3>
            <p style={{ color: 'var(--ink-subtle)', fontSize: '0.85rem', margin: '0.2rem 0 0' }}>Track pet adoptions, vets, and emergency animal rescues.</p>
          </div>
          <button style={btnPrimary}>Dispatch Rescue</button>
        </div>
        
        {loading ? <p style={{ color: 'var(--ink-muted)' }}>Loading animal welfare metrics...</p> : (
