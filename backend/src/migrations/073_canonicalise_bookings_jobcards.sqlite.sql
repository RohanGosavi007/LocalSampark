-- Migration 073 (SQLite): home_service_bookings and job_cards
--
...
ALTER TABLE home_service_bookings ADD COLUMN booking_ref TEXT;
ALTER TABLE home_service_bookings ADD COLUMN category_id TEXT;
ALTER TABLE home_service_bookings ADD COLUMN booking_date DATETIME;
ALTER TABLE home_service_bookings ADD COLUMN time_slot TEXT;
ALTER TABLE home_service_bookings ADD COLUMN service_address TEXT;
ALTER TABLE home_service_bookings ADD COLUMN pincode TEXT;
ALTER TABLE home_service_bookings ADD COLUMN problem_description TEXT;
...
ALTER TABLE job_cards ADD COLUMN estimated_completion_date DATETIME;
ALTER TABLE job_cards ADD COLUMN device_info TEXT;
ALTER TABLE job_cards ADD COLUMN vehicle_info TEXT;
ALTER TABLE job_cards ADD COLUMN photos TEXT DEFAULT '[]';
ALTER TABLE job_cards ADD COLUMN status_notes TEXT;
