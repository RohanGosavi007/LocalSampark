-- SQLite variant of 108_gate_entry_idempotency.sql. SQLite has no
-- ADD COLUMN IF NOT EXISTS; the runner reports and skips a duplicate-column
...
ALTER TABLE society_visitors ADD COLUMN client_entry_id TEXT;
