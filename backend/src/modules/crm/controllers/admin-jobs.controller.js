...
exports.createJob = async (req, res, next) => {
  try {
    ...
    await query(`INSERT INTO admin_jobs (id, title, description, salary, admin_id)
       VALUES ($1, $2, $3, $4, $5)`,
      [newId, title, description, salary, adminId]
    );

    res.json({ success: true, message: 'Job listing published successfully' });
  } catch (error) {
    next(error);
  }
};
