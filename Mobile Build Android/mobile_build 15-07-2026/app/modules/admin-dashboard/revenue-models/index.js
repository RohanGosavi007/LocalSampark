...
export default function RevenueModelsScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Revenue Models</Text>
      </View>
      <View style={styles.content}>
        ...
        <Text style={styles.path}>Route: /admin-dashboard/revenue-models</Text>
      </View>
    </SafeAreaView>
  );
}
