...
export default function SkilledDispatchScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Skilled Dispatch</Text>
      </View>
      <View style={styles.content}>
        ...
        <Text style={styles.path}>Route: /admin-dashboard/skilled-dispatch</Text>
      </View>
    </SafeAreaView>
  );
}
