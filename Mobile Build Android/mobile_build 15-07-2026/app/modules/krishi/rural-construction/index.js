...
export default function RuralConstructionScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Rural Construction</Text>
      </View>
      <View style={styles.content}>
        ...
        <Text style={styles.path}>Route: /krishi/rural-construction</Text>
      </View>
    </SafeAreaView>
  );
}
