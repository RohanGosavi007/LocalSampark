...
export default function RefurbishedPhonesScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Refurbished Phones</Text>
      </View>
      <View style={styles.content}>
        ...
        <Text style={styles.path}>Route: /krishi/refurbished-phones</Text>
      </View>
    </SafeAreaView>
  );
}
