...
const styles = StyleSheet.create({
  ...
  tierCard: { backgroundColor: '#ffffff', width: 220, padding: 20, borderRadius: 16, borderOpacity: 0.8, borderWidth: 1, borderColor: '#ffffff', marginRight: 16, position: 'relative' },
