...
export default function LoginScreen() {
  ...
  const handleSendOtp = async () => {
    ...
    setLoading(true);
    try {
      // Direct call to API since AuthContext only has loginWithDevPreset currently
      // We will emulate it for now if we can't reach the API, but let's try the real API first
