...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, SafeAreaView, Dimensions, Animated, Image } from 'react-native';
          ...
          >
            ...
            <View style={styles.ctaGroup}>
              ...
              <View style={styles.secondaryCtaGroup}>
                <TouchableOpacity style={styles.secondaryBtn} onPress={() => router.push('/modules/krishi')}>
                  <Text style={styles.secondaryBtnText}>🌾 Krishi Hub</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.secondaryBtn} onPress={() => router.push('/modules/franchise')}>
