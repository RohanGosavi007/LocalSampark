...
export default function AdminPremiumScreen() {
  ...
  const fetchData = async () => {
    try {
      ...
      console.warn('Failed to fetch premium:', e);
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>👑 Premium Members (Free Trial)</Text>
      </View>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={<Text style={styles.emptyText}>No data available for Premium Members (Free Trial)</Text>}
        />
      )}
    </SafeAreaView>
  );
