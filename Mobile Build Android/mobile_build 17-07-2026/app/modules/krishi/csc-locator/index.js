...
export default function csclocatorWebViewScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-slate-950">
      <View className="flex-row items-center p-4 border-b border-slate-800 bg-slate-900">
        ...
        <Text className="text-white text-xl font-bold capitalize">csc locator</Text>
      </View>

      <WebView 
        source={{ uri: 'https://localsampark.in/csc-locator' }}
